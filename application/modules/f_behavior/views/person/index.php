<h1>แบบคำนวณโรคอ้วนลงพุง </h1>
<form action="f_behavior/person/save" method="post" class="form-control">
	...
	<div class="alert alert-info alert-block" id="result_fat"><span class="label label-info">ผลการคำนวณ </span> <span>
	...
	<h1>แบบประเมินตนเอง เรื่องพฤติกรรมการกิน ออกกำลังกาย และอารมณ์</h1>
	<div id="span7">
		...
		<table class="table offset1" style="width:60%;background-color:#FFFFFF">
			<tr>
		...
		<div class="aligncenter"><button type="submit" class="btn btn-primary btn-large" style="width:300px;">ยืนยัน</button></div>
	</div>
</form>
