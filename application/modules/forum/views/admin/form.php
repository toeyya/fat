...
<div class="row">
	<div class="col-lg-12">
		<div class="box">
			...
			<form class="form-horizontal" role="form" method="post" action="forum/admin/save/<?php echo $value["id"]?>" enctype="multipart/form-data">
		...
		<div class="box"  >
			...
			<div class="box-content" style="height: 50px;" >
			    ...
			    <label for="title" class="col-sm-2 control-label">
				    ...
				    <div class="col-sm-2">
						<a href="forum/admin/form_comment/<?php echo $item["id"]?>" class="btn btn-primary" >แก้ข้อความ</a>
						<a href="forum/admin/delete_comment/<?php echo $item["id"]?>" class="btn btn-danger" onclick="return confirm('ต้องการลบความคิดเห็น');" >ลบ</a>
				    </div>
