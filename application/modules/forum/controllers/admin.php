...
class Admin extends Admin_Controller {
	...
	public function index() {
		$data["variable"] = $this->topic->where("webboard_group_id = 1")->get();
	...
	public function save_comment($id) {
		if($_POST) {
			...
			set_notify('success',SAVE_DATA_COMPLETE);
			$value = $this->comment->get_row("webboard_comment.id",$id);
			$topic = $value["webboard_topic_id"];
		}
		redirect("forum/admin");
	}
