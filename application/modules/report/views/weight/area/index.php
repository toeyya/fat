...
<tr>
	...
	<td><?php $w[$key]  =(empty($waistline[$item['province_id']][1])) ? 0 : $waistline[$item['province_id']][1]; echo number_format($w[$key],2); $waist1[] = $w[$key]; ?></td>
	<td><?php $we1[$key] = (empty($weight[$item['province_id']]['sum'][1])) ? 0 : $weight[$item['province_id']]['sum'][1]; echo number_format($we1[$key],2); $w_sum1[] = $we1[$key]; ?></td>
	<td><?php $we_avg[$key] = (empty($weight[$item['province_id']]['avg'][1])) ? 0 : $weight[$item['province_id']]['avg'][1]; echo number_format($we_avg[$key],2); $w_avg1[] = $we_avg[$key]; ?></td>
	<td><?php $s = (empty($sd[$item['province_id']][1])) ? 0 : $sd[$item['province_id']][1]; echo number_format(round($s,2),2);$sd1[] = $s; ?></td>
	...
	<td><?php $w2[$key]  =(empty($waistline[$item['province_id']][2])) ? 0 : $waistline[$item['province_id']][2]; echo number_format($w2[$key],2); $waist2[] = $w2[$key]; ?></td>
	<td><?php $we2[$key] = (empty($weight[$item['province_id']]['sum'][2])) ? 0 : $weight[$item['province_id']]['sum'][2]; echo number_format($we2[$key],2); $w_sum2[] = $we2[$key]; ?></td>
	<td><?php $we_avg2[$key] = (empty($weight[$item['province_id']]['avg'][2])) ? 0 : $weight[$item['province_id']]['avg'][2]; echo number_format($we_avg2[$key],2); $w_avg2[] = $we_avg2[$key]; ?></td>
	<td><?php $s = (empty($sd[$item['province_id']][2])) ? 0 : $sd[$item['province_id']][2]; echo number_format(round($s,2),2);$sd2[] = $s; ?></td>
...
<tr><td colspan="2">รวม</td>
	<td><?php echo number_format(array_sum($type1),2); ?></td>
	<td><?php echo number_format(array_sum($type2),2); ?></td>
	<td><?php echo number_format(array_sum($type3),2); ?></td>
	<td><?php echo number_format(array_sum($type4),2); ?></td>
	<td><?php echo number_format(array_sum($type5),2); ?></td>
	<td><?php echo number_format(array_sum($type6),2); ?></td>
	<td><?php echo number_format(array_sum($type_sum),2);?></td>
	<td><?php echo number_format(array_sum($total1),2);?></td>
	<td><?php echo number_format(array_sum($user_total1),2);?></td>
	<td></td>
	<td><?php echo number_format(array_sum($f1),2);?></td>
	<td></td>
	<td><?php echo number_format(array_sum($waist1),2);?></td>
	<td><?php echo number_format(array_sum($w_sum1),2);?></td>
	<td><?php echo number_format(array_sum($w_avg1),2) ?></td>
	<td><?php echo number_format(array_sum($sd1),2);?></td>
	<td><?php echo number_format(array_sum($total2),2);?></td>
	<td><?php echo number_format(array_sum($user_total2),2);?></td>
	<td></td>
	<td><?php echo number_format(array_sum($f2),2);?></td>
	<td></td>
	<td><?php echo number_format(array_sum($waist2),2);?></td>
	<td><?php echo number_format(array_sum($w_sum2),2);?></td>
	<td><?php echo number_format(array_sum($w_avg2),2) ?></td>
	<td><?php echo number_format(array_sum($sd2),2);?></td>
	<td><?php echo number_format(array_sum($diff1),2);?></td>
	<td><?php echo number_format(array_sum($diff2),2);?></td>
	<td><?php echo number_format(array_sum($diff3),2) ?></td>
	<td><?php echo number_format(array_sum($diff4),2);?></td>
</tr>
</table>
