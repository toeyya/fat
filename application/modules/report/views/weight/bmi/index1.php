...
<tbody>
	<tr>
		...
		<td><?php $percent[1] = ($n==0 || $total[1][$time]==0) ? 0 :number_format(($n*100)/$total[1][$time],1);echo number_format($percent[1],1)."%"; ?></td>
		<td><?php $n =(empty($waist[2]['ผอม'])) ? 0 : $waist[2]['ผอม']; echo number_format($n); $female1[1] = $n; ?></td>
		<td><?php $fpercent[1] = ($n==0 || $total[2][$time]==0) ? 0 :number_format(($n*100)/$total[2][$time],1);echo number_format($fpercent[1],1)."%"; ?></td>
	...
	<tr>
		...
		<td><?php $percent[2] = ($n==0 || $total[1][$time]==0) ? 0 :number_format(($n*100)/$total[1][$time],1);echo number_format($percent[2],1)."%"; ?></td>
		<td><?php $n =(empty($waist[2]['ปกติ'])) ? 0 : $waist[2]['ปกติ']; echo number_format($n); $female1[2] = $n; ?></td>
		<td><?php $fpercent[2] = ($n==0 || $total[2][$time]==0) ? 0 :number_format(($n*100)/$total[2][$time],1);echo number_format($fpercent[2],1)."%"; ?></td>
	...
	<tr>
		...
		<td><?php $percent[3] = ($n==0 || $total[1][$time]==0) ? 0 :number_format(($n*100)/$total[1][$time],1);echo number_format($percent[3],1)."%"; ?></td>
		<td><?php $n =(empty($waist[2]['ท้วม'])) ? 0 : $waist[2]['ท้วม']; echo number_format($n); $female1[3] = $n; ?></td>
		<td><?php $fpercent[3] = ($n==0 || $total[2][$time]==0) ? 0 :number_format(($n*100)/$total[2][$time],1);echo number_format($fpercent[3],1)."%"; ?></td>
	...
	<tr>
		...
		<td><?php $percent[4] = ($n==0 || $total[1][$time]==0) ? 0 :number_format(($n*100)/$total[1][$time],1);echo number_format($percent[4],1)."%"; ?></td>
		<td><?php $n =(empty($waist[2]['อ้วน'])) ? 0 : $waist[2]['อ้วน']; echo number_format($n); $female1[4] = $n; ?></td>
		<td><?php $fpercent[4] = ($n==0 || $total[2][$time]==0) ? 0 :number_format(($n*100)/$total[2][$time],1);echo number_format($fpercent[4],1)."%"; ?></td>
	...
	<tr>
		...
		<td><?php $percent[5] = ($n==0 || $total[1][$time]==0) ? 0 :number_format(($n*100)/$total[1][$time],1);echo number_format($percent[5],1)."%"; ?></td>
		<td><?php $n =(empty($waist[2]['อ้วนมาก'])) ? 0 : $waist[2]['อ้วนมาก']; echo number_format($n); $female1[5] = $n; ?></td>
	    <td><?php $fpercent[5] = ($n==0 || $total[2][$time]==0) ? 0 :number_format(($n*100)/$total[2][$time],1);echo number_format($fpercent[5],1)."%"; ?></td>
