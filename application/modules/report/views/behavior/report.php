...
<div class="aligncenter"><button name="btn_print" class="btn btn-default btn-large" type="button" onclick="window.print();">พิมพ์ข้อมูล</button></div>
</div>