					  ...
					  <thead>
						  ...
						  <tr>
						  	...
						  	<td>
								...
								<a class="btn btn-danger btn-sm" href="km/admin/km/delete/<?php echo $item['id'] ?>" onclick="return confirm('<?php echo NOTICE_CONFIRM_DELETE ?>')"><i class="fa fa-trash-o "></i></a>
								<?php endif; ?>
								</td>
						  </tr>
						  <?php $i++; endforeach; ?>
