...
<tr>
	...
	<td><input type="text" name="fat[]"  		value="<?php echo ($item['time']=="2") ? $item['fat']:'' ?>"	   class="noborder aligncenter w100  <?php if(!empty($fat_mean[$item['fat']]) && $item['time']=="2"){ echo $fat_mean[$item['fat']];} ?>" readonly="readonly" ></td>
	...
	<td><input type="text" name="bmi_mean[]"  	value="<?php echo ($item['time']=="2") ?  $item['bmi_mean']:'' ?>" class="bmi-mean noborder aligncenter w100 <?php if(!empty($bmi_mean[$item['bmi_mean']]) && $item['time']=="2"){ echo $bmi_mean[$item['bmi_mean']];} ?>"  readonly="readonly">
