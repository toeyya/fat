				...
				if($lastpage > 1){
						if($this->page){
								...
								if($this->page > 1)
										...
										$this->pagination .= "<li><a href=\"".$this->get_pagenum_link($prev)."\" class=\"prev\">Prev</a></li>";
									else
										//$this->pagination .= "<span class=\"disabled\">$p</span>";
									    $this->pagination .= "<li class=\"disabled\"><a href=\"".$this->get_pagenum_link($prev)."\" class=\"prev\">Prev</a></li>";
							}
						//pages
						...
						elseif($lastpage > 5 + ($this->adjacents * 2)){//enough pages to hide some
								...
								if($this->page < 1 + ($this->adjacents * 2)){
										...
										//$this->pagination .= "...";
										$this->pagination .= "<li class=\"disabled\"><span>...<span></li>";
								...
								elseif($lastpage - ($this->adjacents * 2) > $this->page && $this->page > ($this->adjacents * 2)){
										...
										$this->pagination .= "<li><span class=>...</span></li>";
						...
						if($this->page){
								...
								if ($this->page < $counter - 1)
										...
										$this->pagination .= "<li><a href=\"".$this->get_pagenum_link($next)."\">Next</a></li>";
									else
										//$this->pagination .= "<span class=\"disabled\">$n</span>";
									    $this->pagination .= "<li class=\"disabled\"><a href=\"".$this->get_pagenum_link($next)."\">Next</a></li>";
									//if($this->showCounter)$this->pagination .= "<p>จำนวนทั้งหมด $this->total_pages เรคอร์ด</p>";
							}
					}
